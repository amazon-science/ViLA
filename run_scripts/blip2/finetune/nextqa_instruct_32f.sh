...
exp_name='blip2_nextqa_instruct_32f'
CUDA_VISIBLE_DEVICES=1,2,3,4,5,6,7 python -m torch.distributed.run --nproc_per_node=7 train.py \
--cfg-path lavis/projects/blip2/train/nextqa_instruct_32f.yaml \
--options run.output_dir=${result_dir}${exp_name}


exp_name='nextqa_ft_16f'
