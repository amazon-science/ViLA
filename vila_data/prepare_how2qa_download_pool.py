...
def f(video_name):
    mp4 = 'aws s3 cp s3://m5-video/HowTo100M/videos/{}.mp4 /scratch_xijun/data/How2QA/videos_pool/{}.mp4  --profile m5'.format(
        video_name, video_name)
    returned_value_mp4 = os.system(mp4)
    webm = 'aws s3 cp s3://m5-video/HowTo100M/videos/{}.webm /scratch_xijun/data/How2QA/videos_pool/{}.webm  --profile m5'.format(
        video_name, video_name)
    returned_value_webm = os.system(webm)
    if returned_value_mp4 == 0 or returned_value_webm == 0:
        return
    else:
        bad.append(video_name)

# for video_name in how2qa_videos:
#     mp4 = 'aws s3 cp s3://m5-video/HowTo100M/videos/{}.mp4 /scratch_xijun/data/How2QA/videos/{}.mp4  --profile m5'.format(video_name, video_name)
#     returned_value_mp4 = os.system(mp4)
#     webm = 'aws s3 cp s3://m5-video/HowTo100M/videos/{}.webm /scratch_xijun/data/How2QA/videos/{}.webm  --profile m5'.format(video_name, video_name)
#     returned_value_webm = os.system(webm)
#     if returned_value_mp4==0 or returned_value_webm==0:
#         continue
#     else:
...
if __name__ == '__main__':
    with Pool() as p:
        p.map(f, how2qa_videos)
    print(len(bad))
    save_json(bad, 'how2qa_videos_bad.json')
