...
@registry.register_model("blip2_t5_instruct_vqa_t160")
class Blip2T5InstructVQAT160(Blip2Base):
    """
    BLIP2 T5 model.
    ...
    def forward(self, samples):
        ...
        for i in range(len(samples['qa_input'])):
            #print(text[i])
            samples['qa_input'][i] = 'Question: Write a detailed description for the photo. Answer: ' + text[i] + '. ' + samples['qa_input'][i]
        # tt
    ...
    def generate(
        ...
        for i in range(len(samples['qa_input'])):
            # print(text[i])
            samples['qa_input'][i] = 'Question: Write a detailed description for the photo. Answer: ' + text[i] + '. ' + \
                                     samples['qa_input'][i]
        # tt
    ...
    def predict_answers(
        ...
        **kwargs
        ...
        prompt = ["Write a detailed description for the photo." for _ in range(len(samples["qa_input"]))]
