...
@registry.register_model("blip2_t5_instruct_vqa_fidx")
class Blip2T5InstructVQAFidx(Blip2Base):
    """
    BLIP2 T5 model.
    ...
    def forward(self, samples):
        ...
        for j in range(image.size(1)):
            ...
            inputs_t5.append(frame_inputs_t5.unsqueeze(dim=1))
            atts_t5.append(frame_atts_t5.unsqueeze(dim=1))
        ...
        with torch.cuda.amp.autocast(dtype=torch.bfloat16):
            ...
            inputs_t5 = torch.cat([vid_prefix_embed, inputs_t5], dim=2)  # b, t, n_word + m, c
            atts_t5 = torch.cat([vid_prefix_mask, atts_t5], dim=2)  # b, t, n_word + m
