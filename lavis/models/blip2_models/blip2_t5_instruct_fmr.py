...
@registry.register_model("blip2_t5_instruct_fmr")
class Blip2T5InstructFmr(Blip2Base):
    """
    BLIP2 T5 model.
    ...
    def __init__(
        ...
        if not qformer_text_input:
            ...
            self.Qformer_loc.resize_token_embeddings(len(self.tokenizer))
    ...
    def generate(
        ...
        text_input, bs_answer = samples['loc_input'], samples[
            'qa_output']  # Q + Options + Prompt: Choose an answer from options based on the frame.
